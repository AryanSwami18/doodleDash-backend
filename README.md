...
Built using **Node.js**, **Socket.IO**, and **TypeScript**, this server handles live gameplay including drawing synchronization, chat, scoring, and round management.
...
- Word visible only to the drawer  
